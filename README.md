...
* **High-Speed Hardware Processing**: Captures frames natively via ESP-32CAM and renders them directly to a round SPI TFT screen.
...
* **Serial Hardware Integration**: Sends recognized RFID payload data over USB Serial to an ESP8266/ESP32 to trigger the machinery relays.
